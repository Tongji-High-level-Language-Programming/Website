...
+ 助教都是**志愿者**，他们不欠你钱、也不从答疑中获得报酬。互相尊重是交流的起点。
...
高程往往会为作业提供足够详细的文档，并对常见问题提供说明。如果你在作业过程中遇到问题，请先确保你已经完整阅读了有关部分，包括但不限于文档开头、结尾、前后几页、[常见问题解答](/qa/faq/) 等。

课程的答疑将通过 [同济高程答疑平台](/qa/gitea/) 的 Issue 区进行，提问前也请先在平台上搜索是否已有相同问题的解答。
...
历史上，相当比例的问题都产生于提问者没有认真阅读。如果你看到了这样的问题，不妨用下图回复它：  
...
提问时，请使用 [截屏](/qa/faq/#截屏) 提供信息。除非问题发生的时机实在无法截屏（如计算机启动过程中），否则请勿使用手机对电脑屏幕拍照并发送，原因包括：
